...
public class DienMay {
    ...
    public  DienMay (int maHang, String tenHang, double donGia, Date nSX, Date hSD) {
        this.maHang = maHang;
    ...
    public String toString() {
        ...
        return "Thông tin về Điện Máy: \n" +
                "3 : " + maHang +
                "\nQuạt,Đèn,Tủ lạnh : '" + tenHang +
                "\n50.000VND : " + str +
                "\n20/08/2021 : " + str1 +
                "\n20/01/2022 : " + str2;
    }
    ...
    public boolean kiemTraTenHang(boolean k) {
        if (this.tenHang == "" || this.tenHang.isEmpty()) {
            System.out.println("Quạt,Đèn,Tủ lạnh: ");
        } else {
            k = false;
        }
        return k;
